...
find_program(CMAKE_AVR_AR avr-ranlib REQUIRED)

if (NOT CMAKE_AVR_MCU)
    set(CMAKE_AVR_MCU atmega32u4)
endif()

if (NOT CMAKE_AVR_F_CPU)
    set(CMAKE_AVR_F_CPU 16000000)
endif()
...
set(CMAKE_TRY_COMPILE_PLATFORM_VARIABLES CMAKE_AVR_MCU)